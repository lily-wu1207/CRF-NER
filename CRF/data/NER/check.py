...
if __name__ == "__main__":
    ...
    check(language="Chinese", gold_path="./Chinese/chinese_test.txt", my_path="./Chinese/Chinese_my_result.txt")

    # check(language="English", gold_path="./English/english_test.txt", my_path="./English/English_my_result.txt")
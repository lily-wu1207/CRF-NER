...
if __name__ == "__main__":
    ...
    # check(language="Chinese", gold_path="./test/chinese_test.txt", my_path="./test/Chinese_my_result.txt")

    check(language="English", gold_path="./test/english_test.txt", my_path="./test/English_my_result.txt")